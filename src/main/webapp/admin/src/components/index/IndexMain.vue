<template>
	<div style="height: 100%;">
		...
		<el-main :style='"horizontal" == "vertical" ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<index-header :style='{"boxShadow":"0 1px 6px rgba(64, 158, 255, .2)","padding":"8px 20px","margin":"0 0 15px","alignItems":"center","background":"#F6B939","display":"flex","width":"100%","position":"relative","justifyContent":"center","zIndex":"1"}'></index-header>
			...
			<bread-crumbs :title="title" :style='{"padding":"15px 20px","margin":"15px auto 0 auto","borderColor":"#F68B39","borderWidth":"5px 0 0px 0","background":"#FFEFCD","width":"100%","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
