...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="儿童姓名" prop="ertongxingming">
            <el-select  @change="ertongxingmingChange" v-model="ruleForm.ertongxingming" placeholder="请选择儿童姓名">
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="床位号" prop="chuangweihao">
            <el-input v-model="ruleForm.chuangweihao" 
                placeholder="床位号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="分配日期" prop="fenpeiriqi" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="备注" prop="beizhu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="备注"
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/ertongxinxi/ertongxingming', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      ertongxingmingChange () {
        this.$http.get('follow/ertongxinxi/ertongxingming?columnValue=' + this.ruleForm.ertongxingming, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
          }
        });
      },
